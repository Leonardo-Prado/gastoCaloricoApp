...
public class DBHelp extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
       try {
           ...
           sqLiteDatabase.execSQL("CREATE TABLE Usuarios (_id INTEGER PRIMARY KEY AUTOINCREMENT,Nome TEXT NOT NULL,Email TEXT NOT NULL,Senha TEXT NOT NULL,Idade INTEGER,Sexo INTEGER,MassaCorporal REAL,Altura REAL,Logado INTEGER NOT NULL,Metodo INTEGER NOT NULL,FirebaseToken TEXT,GoogleToken TEXT,FacebookToken TEXT,FirebaseUId TEXT,GoogleUId TEXT,FacebookUId TEXT,DataCriacao INTEGER,PesoMinimo REAL DEFAULT 1,PesoMaximo REAL DEFAULT 2,GastoMinimo REAL DEFAULT 1,GastoMaximo REAL DEFAULT 2,GastoMedio REAL DEFAULT 1)");
