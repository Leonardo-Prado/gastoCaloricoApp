...
public class JustifyTextView extends AppCompatTextView {
        ...
        private void initialize(AttributeSet attrs) {
            ...
            if (attrs != null) {
                TypedArray attrArray = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.JustifyTextView, 0, 0);
                if (attrArray != null) {
                    mJustified = attrArray.getBoolean(R.styleable.JustifyTextView_justified, false);
                }
            }
        }
